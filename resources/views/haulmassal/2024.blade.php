...
<script>
    $.ajax({
        url: api_server + "/api/nyadran/all?year=2024&per_page=100&page=1",
        cache: false,
        beforeSend: function() {
    ...
    function GetData(page, limit){
        $.ajax({
            url: api_server + "/api/nyadran/all?year=2024&per_page=100&page="+page,
            method: "GET",
            cache: false,
            beforeSend: function() {
                $('#loading').removeClass('hidden')
    ...
    function show_table_haul(data, page, limit){
        ...
        $("#search-data-public-btn").on("click", function() {
            ...
            if (value != "") {
                ...
                $.ajax({
                    method: 'POST',
                    url: api_server + "/api/nyadran/search?year=2024",
                    timeout: 0,
                    headers: {
        ...
        $.ajax({
            url: api_server+"/api/nyadran/statistik?year=2024",
            method: "get",
            timeout: 0,
            success: function(response){
                stats_html = ""
